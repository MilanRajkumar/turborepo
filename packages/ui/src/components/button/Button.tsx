...
export const classes = {
  ...
  color: {
    ...
    primary:
      'bg-blue-600 text-white hover:bg-blue-800 focus:ring-2 focus:ring-blue-500',
    danger:
      'bg-red-500 text-white hover:bg-red-800 focus:ring-2 focus:ring-red-300',
    success:
